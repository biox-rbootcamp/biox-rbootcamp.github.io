...
The goal is to work through this lab by running all the R code, as explained in Lab0. Then you will execute all code chunks sequentially. We encourage you to take advantage of the interactivity by modifying commands and seeing how the output changes.
Once you get to the end of this lab, go to [Canvas](https://canvas.stanford.edu)  to answer some questions related to its material (Quiz 1, due Wednesday midnight).
...
In class you learned about many distributions, for example you learned about the Binomial distribution (which has the Bernoulli distribution as a special case), as well as the Poisson distribution.
