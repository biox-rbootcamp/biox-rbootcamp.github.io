...
The goal is to work through this lab by running all the R code/ Then you will execute all code chunks sequentially. We encourage you to take advantage of the interactivity by modifying commands and seeing how the output changes.
