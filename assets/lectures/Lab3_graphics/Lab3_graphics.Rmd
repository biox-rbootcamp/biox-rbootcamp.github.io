...
Begin by watching the [lecture on vizualization](https://drive.google.com/file/d/1BBNvt2EWtZnixHbGxnXg-vbivP7Iu0EI/view?usp=sharing): this will provide you with an introduction to the importance of plotting and give you an overview of the different plotting functions with ggplot2. This is a considerably longer video than what we've seen so far, so prepare ample time!

Once you're done, go through the following lab which we will discuss on Thursday.
...
## CpG Islands: Optional

This part is a little more involved. Feel free to read through if that is of interest to you.
