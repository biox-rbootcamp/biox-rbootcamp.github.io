...
(Guaranteed nesting can be helpful for interpretation.)
...
The @lun2017assessing dataset contains two 96-well plates of 416B cells (an immortalized mouse myeloid progenitor cell line), processed using the Smart-seq2 protocol [Picelli 2014].
...
Load [the data](https://biox-rbootcamp.github.io/material) from the class website.
...
__Question 4__ Apply hierarchical clustering to the mock dataset. Where would you cut it?