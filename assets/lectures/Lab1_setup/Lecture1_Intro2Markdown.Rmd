...
You should have installed R -Studio during the first discussion --- if you have, skip over to the next session. Otherwise, follow the instructions underneath.
...
2. Name the Markdown document (in the title section) "Lab 2" and check that the output is a pdf document.
3. Complete the exercises in the template.
4. When you're done, "knit" your pdf and send it to the course instructor with "Bootcamp: Lab2" in the email object.
