...
a. Find the maximum number of movies that a director has been involved in.

b. Find the average and median number of action movies that a director is involved in.

c. Compute 5th and 95th percentile of the `gross` amount, per category.
