...
1. We run the simulation 1000 times
...
c. ii. Suppose you want to check if diet A is as efficient as diet B. What test would you use? 
...
That is, consider $T_g = \sum_{i=1}^{n_g} \text{sign}(X_{i1} - X_{i0})$.

i. Under the null, what is the distribution of this test?

ii. Using the following simulated data, assess whether or not you can reject the null.
