...
<div style="text-align: center;"> 
![Tosser](../figures/tosser3.png){width="50%"}
...
-------------------:|:----------------:|:-------------------        
![Avicenna](`r input_dir("images/Avicenna.png")`){width="100%"} | ![The Physician](../figures/medicus.jpeg){width="100%"} | His *Canon of Medicine (1020)*  lists seven rules of experimental design, including the need for controls and replication, the danger of confounding and the necessity of changing only one factor at a time.
...
![](../figures/CompleteRB3.png){width="50%"}
...
![](../figures/balincomblock.png){width="50%"}

## Complete Factorial Latin Squares
![sudoku anyone?](../figures/LatinSquare9.png){width="50%"}
...
![Response to a transient perturbation](../figures/SamplingDesignSmall.png){width="60%"}
...
![](../figures/leakypipeline.png){width="25%"}
