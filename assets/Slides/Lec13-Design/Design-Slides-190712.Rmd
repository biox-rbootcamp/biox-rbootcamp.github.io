...
output: 
  slidy_presentation:
    font_adjustment: +1
bibliography: /Users/Susan/Books/CUBook/Biobook.bib
link-citations: no
---
...
:-------------------------:|:------------------------------------------:
![image](http://bios221/book/images/RAFisherSmoking.png){width="50%"}|  *“To consult the statistician after an experiment is finished is often merely to ask him to conduct a post mortem examination. He can perhaps say what the experiment died of.”*:
...
![Phylochip example](/Users/Susan/Books/CUBook/images/ThreeSets28s.png)
...
:-------------------------:|:------------------------------------------:        
![Avicenna](/Users/Susan/Books/CUBook/images/Avicenna.png){width="60%"}| In the *Canon of Medicine, 1020* are listed seven rules of experimental design, including the need for controls and replication, the danger of confounding and the necessity of changing only one factor at a time |
...
# Leaky pipelines and statistical sufficiency![](/Users/susan/Dropbox/images/leakypipeline.png){width="25%"}
